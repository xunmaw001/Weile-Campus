...
public class DaipiaoCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public DaipiaoCollectionEntity() {

	}

	public DaipiaoCollectionEntity(T t) {
		try {
    ...
    public String toString() {
        return "DaipiaoCollection{" +
            ", id=" + id +
            ", daipiaoId=" + daipiaoId +
            ", yonghuId=" + yonghuId +
            ", daipiaoCollectionTypes=" + daipiaoCollectionTypes +
