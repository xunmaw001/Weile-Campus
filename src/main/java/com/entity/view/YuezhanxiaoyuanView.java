...
public class YuezhanxiaoyuanView extends YuezhanxiaoyuanEntity implements Serializable {
	...
	*/
	...
	public YuezhanxiaoyuanView() {

	}

	public YuezhanxiaoyuanView(YuezhanxiaoyuanEntity yuezhanxiaoyuanEntity) {
		try {
			BeanUtils.copyProperties(this, yuezhanxiaoyuanEntity);
	...
	*/
	...
	public String toString() {
		return "YuezhanxiaoyuanView{" +
			", yuezhanxiaoyuanValue=" + yuezhanxiaoyuanValue +
