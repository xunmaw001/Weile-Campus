...
public class DaipiaoCollectionView extends DaipiaoCollectionEntity implements Serializable {
	...
	*/
	...
	private String daipiaoCollectionValue;
	...
	public DaipiaoCollectionView() {

	}

	public DaipiaoCollectionView(DaipiaoCollectionEntity daipiaoCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, daipiaoCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getDaipiaoCollectionValue() {
		return daipiaoCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setDaipiaoCollectionValue(String daipiaoCollectionValue) {
		this.daipiaoCollectionValue = daipiaoCollectionValue;
	}
	...
	public String toString() {
		return "DaipiaoCollectionView{" +
			", daipiaoCollectionValue=" + daipiaoCollectionValue +
