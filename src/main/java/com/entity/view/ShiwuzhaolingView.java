...
public class ShiwuzhaolingView extends ShiwuzhaolingEntity implements Serializable {
	...
	*/
	...
	private String shiwuzhaolingZhuangtaiValue;
	...
	* 获取： 状态的值
	*/
	public String getShiwuzhaolingZhuangtaiValue() {
		return shiwuzhaolingZhuangtaiValue;
	}
	/**
	* 设置： 状态的值
	*/
	public void setShiwuzhaolingZhuangtaiValue(String shiwuzhaolingZhuangtaiValue) {
		this.shiwuzhaolingZhuangtaiValue = shiwuzhaolingZhuangtaiValue;
	}
	...
	public String toString() {
		return "ShiwuzhaolingView{" +
			...
			", shiwuzhaolingZhuangtaiValue=" + shiwuzhaolingZhuangtaiValue +
