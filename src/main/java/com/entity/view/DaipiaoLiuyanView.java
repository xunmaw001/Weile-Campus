...
public class DaipiaoLiuyanView extends DaipiaoLiuyanEntity implements Serializable {
	...
	public DaipiaoLiuyanView() {

	}

	public DaipiaoLiuyanView(DaipiaoLiuyanEntity daipiaoLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, daipiaoLiuyanEntity);
