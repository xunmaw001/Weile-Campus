...
public class JiaocheChatView extends JiaocheChatEntity implements Serializable {
	...
	*/
	...
	private String jiaocheChatValue;
	...
	public JiaocheChatView() {

	}

	public JiaocheChatView(JiaocheChatEntity jiaocheChatEntity) {
		try {
			BeanUtils.copyProperties(this, jiaocheChatEntity);
	...
	* 获取： 数据类型的值
	*/
	public String getJiaocheChatValue() {
		return jiaocheChatValue;
	}
	/**
	* 设置： 数据类型的值
	*/
	public void setJiaocheChatValue(String jiaocheChatValue) {
		this.jiaocheChatValue = jiaocheChatValue;
	}
	...
	public String toString() {
		return "JiaocheChatView{" +
			", zhuangtaiValue=" + zhuangtaiValue +
			", jiaocheChatValue=" + jiaocheChatValue +
			", sijiName=" + sijiName +
			", sijiPhone=" + sijiPhone +
