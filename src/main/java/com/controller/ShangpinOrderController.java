...
//                            shangpinOrderEntity.setShangpinOrderCourierName(data.get(0));                    //联系人 要改的
//                            shangpinOrderEntity.setShangpinOrderCourierNumber(data.get(0));                    //联系方式 要改的
...
//                            shangpinOrderEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R add(@RequestBody ShangpinOrderEntity shangpinOrder, HttpServletRequest request){
        ...
        YonghuEntity yongyouzhe = yonghuService.selectById(shangpinEntity.getYonghuId());
        yongyouzhe.setNewMoney(yongyouzhe.getNewMoney()+shangpinOrder.getShangpinOrderTruePrice());
        yonghuService.updateById(yongyouzhe);
//            YonghuEntity yonghuEntity = new YonghuEntity();
//            yonghuEntity.setNewMoney(yonghuEntity.getNewMoney()+shangpinOrder.getShangpinOrderTruePrice());//动态计算金额
//            yonghuService.updateById(yonghuEntity);
    ...
    */
    ...
    public R refund(Integer id, HttpServletRequest request){
        ...
        String role = String.valueOf(request.getSession().getAttribute("role"));
            ...
            Integer userId = (Integer) request.getSession().getAttribute("userId");
            YonghuEntity yonghuEntity = yonghuService.selectById(userId);//支付者
            if(yonghuEntity == null)
                return R.error(511,"用户不能为空");
            if(yonghuEntity.getNewMoney() == null)
                return R.error(511,"用户金额不能为空");
    ...
    */
    ...
    public R deliver(Integer id ,String shangpinOrderCourierNumber, String shangpinOrderCourierName){
        ...
        shangpinOrderEntity.setShangpinOrderTypes(103);//设置订单状态为已确认
