    ...
    */
    ...
    public R save(@RequestBody ShiwuzhaolingEntity shiwuzhaoling, HttpServletRequest request){
        ...
        Wrapper<ShiwuzhaolingEntity> queryWrapper = new EntityWrapper<ShiwuzhaolingEntity>()
            ...
            .eq("shiwuzhaoling_address", shiwuzhaoling.getShiwuzhaolingAddress())
            .eq("shiwuzhaoling_types", shiwuzhaoling.getShiwuzhaolingTypes())
            .eq("shiwuzhaoling_clicknum", shiwuzhaoling.getShiwuzhaolingClicknum())
            .eq("shiwuzhaoling_zhuangtai_types", shiwuzhaoling.getShiwuzhaolingZhuangtaiTypes())
            ;

        logger.info("sql语句:"+queryWrapper.getSqlSegment());
        ShiwuzhaolingEntity shiwuzhaolingEntity = shiwuzhaolingService.selectOne(queryWrapper);
        if(shiwuzhaolingEntity==null){
            shiwuzhaoling.setShiwuzhaolingClicknum(1);
            shiwuzhaoling.setInsertTime(new Date());
...
//                            shiwuzhaolingEntity.setShiwuzhaolingUuidNumber(data.get(0));                    //物品编号 要改的
//                            shiwuzhaolingEntity.setShiwuzhaolingPhoto("");//详情和图片
//                            shiwuzhaolingEntity.setShiwuzhaolingAddress(data.get(0));                    //丢失地点/找到地点 要改的
//                            shiwuzhaolingEntity.setShiwuzhaolingTypes(Integer.valueOf(data.get(0)));   //物品类型 要改的
//                            shiwuzhaolingEntity.setJutishijianTime(sdf.parse(data.get(0)));          //具体时间 要改的
//                            shiwuzhaolingEntity.setShiwuzhaolingClicknum(Integer.valueOf(data.get(0)));   //热度 要改的
//                            shiwuzhaolingEntity.setShiwuzhaolingContent("");//详情和图片
//                            shiwuzhaolingEntity.setShiwuzhaolingZhuangtaiTypes(Integer.valueOf(data.get(0)));   //状态 要改的
//                            shiwuzhaolingEntity.setInsertTime(date);//时间
    ...
    public R detail(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        ShiwuzhaolingEntity shiwuzhaoling = shiwuzhaolingService.selectById(id);
            if(shiwuzhaoling !=null){
                ...
                //点击数量加1
                shiwuzhaoling.setShiwuzhaolingClicknum(shiwuzhaoling.getShiwuzhaolingClicknum()+1);
