...
//                            shangpinEntity.setShangpinName(data.get(0));                    //二手商品名称 要改的
//                            shangpinEntity.setShangpinUuidNumber(data.get(0));                    //二手商品编号 要改的
//                            shangpinEntity.setShangpinPhoto("");//详情和图片
//                            shangpinEntity.setShangpinTypes(Integer.valueOf(data.get(0)));   //商品类型 要改的
//                            shangpinEntity.setShangpinKucunNumber(Integer.valueOf(data.get(0)));   //二手数量 要改的
//                            shangpinEntity.setShangpinOldMoney(data.get(0));                    //二手商品原价 要改的
//                            shangpinEntity.setShangpinNewMoney(data.get(0));                    //现价/个 要改的
//                            shangpinEntity.setShangpinClicknum(Integer.valueOf(data.get(0)));   //二手商品热度 要改的
...
//                            shangpinEntity.setCreateTime(date);//时间
                        ...
                        if(shangpinEntities_shangpinUuidNumber.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [二手商品编号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
