    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">微乐校园注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <el-form-item label="电子邮箱" class="input" v-if="tableName=='siji'">
                            <el-input v-model="ruleForm.sijiEmail" autocomplete="off" placeholder="电子邮箱"  />
                        </el-form-item>
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/weilexiaoyuan/img/back-img-bg.jpg);
