        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '二手商品名称' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.shangpinName" placeholder="二手商品名称" clearable></el-input>
                     </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/weilexiaoyuan/upload/shangpinMuBan.xls"
                        >批量导入二手商品数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('shangpin','导入导出')"
                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <!--<el-button v-if="isAuth('shangpin','修改')" type="primary" icon="el-icon-add-location" size="mini" @click="plusShangpinKucunNumber(scope.row.id,scope.row.shangpinKucunNumber)">增加二手数量</el-button>-->
                            <!--<el-button v-if="isAuth('shangpin','修改')" type="primary" icon="el-icon-delete-location" size="mini" @click="reduceShangpinKucunNumber(scope.row.id,scope.row.shangpinKucunNumber)">减少二手数量</el-button>-->
...
<script>
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                ...
                //本表字段
                     '二手商品名称': "shangpinName",
                     '二手商品编号': "shangpinUuidNumber",
                     '二手商品照片': "shangpinPhoto",
                     '商品类型': "shangpinValue",
                     '二手数量': "shangpinKucunNumber",
                     '二手商品原价': "shangpinOldMoney",
                     '现价/个': "shangpinNewMoney",
                     '二手商品热度': "shangpinClicknum",
                     '录入时间': "insertTime",
            },
        ...
        methods: {
			...
			//数据不为空放值
				...
				//标题
				this.shangpinKucunNumberTitle = '增加二手数量'
			},
			//减少二手数量
			...
			//数据不为空放值
				...
				this.shangpinKucunNumberVisible = true;
				//标题
				this.shangpinKucunNumberTitle = '减少二手数量'
			},
			//提交用户操作二手数量数量
