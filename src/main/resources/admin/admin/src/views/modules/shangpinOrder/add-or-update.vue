        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='shangpin'">
                    <el-form-item class="select" v-if="type!='info'"  label="二手商品" prop="shangpinId">
                        <el-select v-model="ruleForm.shangpinId" :disabled="ro.shangpinId" filterable placeholder="请选择二手商品" @change="shangpinChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='shangpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="二手商品名称" prop="shangpinName">
                        <el-input v-model="shangpinForm.shangpinName"
                                  placeholder="二手商品名称" clearable readonly></el-input>
                    </el-form-item>
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="联系人" prop="shangpinOrderCourierName">
                       <el-input v-model="ruleForm.shangpinOrderCourierName"
                                 placeholder="联系人" clearable  :readonly="ro.shangpinOrderCourierName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="联系人" prop="shangpinOrderCourierName">
                           <el-input v-model="ruleForm.shangpinOrderCourierName"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="联系方式" prop="shangpinOrderCourierNumber">
                       <el-input v-model="ruleForm.shangpinOrderCourierNumber"
                                 placeholder="联系方式" clearable  :readonly="ro.shangpinOrderCourierNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="联系方式" prop="shangpinOrderCourierNumber">
                           <el-input v-model="ruleForm.shangpinOrderCourierNumber"
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   shangpinId: [
                              { required: true, message: '二手商品不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
