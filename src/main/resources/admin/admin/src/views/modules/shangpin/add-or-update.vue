    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="二手商品名称" prop="shangpinName">
                       <el-input v-model="ruleForm.shangpinName"
                                 placeholder="二手商品名称" clearable  :readonly="ro.shangpinName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="二手商品名称" prop="shangpinName">
                           <el-input v-model="ruleForm.shangpinName"
                                     placeholder="二手商品名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="二手商品编号" prop="shangpinUuidNumber">
                       <el-input v-model="ruleForm.shangpinUuidNumber"
                                 placeholder="二手商品编号" clearable  :readonly="ro.shangpinUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="二手商品编号" prop="shangpinUuidNumber">
                           <el-input v-model="ruleForm.shangpinUuidNumber"
                                     placeholder="二手商品编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.shangpinPhoto" label="二手商品照片" prop="shangpinPhoto">
                        <file-upload
                            tip="点击上传二手商品照片"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.shangpinPhoto" label="二手商品照片" prop="shangpinPhoto">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="二手数量" prop="shangpinKucunNumber">
                       <el-input v-model="ruleForm.shangpinKucunNumber"
                                 placeholder="二手数量" clearable  :readonly="ro.shangpinKucunNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="二手数量" prop="shangpinKucunNumber">
                           <el-input v-model="ruleForm.shangpinKucunNumber"
                                     placeholder="二手数量" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="二手商品原价" prop="shangpinOldMoney">
                       <el-input v-model="ruleForm.shangpinOldMoney"
                                 placeholder="二手商品原价" clearable  :readonly="ro.shangpinOldMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="二手商品原价" prop="shangpinOldMoney">
                           <el-input v-model="ruleForm.shangpinOldMoney"
                                     placeholder="二手商品原价" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="现价/个" prop="shangpinNewMoney">
                       <el-input v-model="ruleForm.shangpinNewMoney"
                                 placeholder="现价/个" clearable  :readonly="ro.shangpinNewMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="现价/个" prop="shangpinNewMoney">
                           <el-input v-model="ruleForm.shangpinNewMoney"
                                     placeholder="现价/个" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="二手商品介绍" prop="shangpinContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.shangpinContent" label="二手商品介绍" prop="shangpinContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   shangpinName: [
                              { required: true, message: '二手商品名称不能为空', trigger: 'blur' },
                          ],
                   shangpinUuidNumber: [
                              { required: true, message: '二手商品编号不能为空', trigger: 'blur' },
                          ],
                   shangpinPhoto: [
                              { required: true, message: '二手商品照片不能为空', trigger: 'blur' },
                          ],
                   shangpinTypes: [
                   ...
                   shangpinKucunNumber: [
                              { required: true, message: '二手数量不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   shangpinOldMoney: [
                              { required: true, message: '二手商品原价不能为空', trigger: 'blur' },
                   ...
                   shangpinNewMoney: [
                              { required: true, message: '现价/个不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]{0,6}(\.[0-9]{1,2})?$/,
                                  message: '只允许输入整数6位,小数2位的数字',
                                  trigger: 'blur'
                              }
                   ...
                   shangpinClicknum: [
                              { required: true, message: '二手商品热度不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   shangpinContent: [
                              { required: true, message: '二手商品介绍不能为空', trigger: 'blur' },
                          ],
                   shangpinDelete: [
