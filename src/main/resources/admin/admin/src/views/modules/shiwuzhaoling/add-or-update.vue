    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="物品编号" prop="shiwuzhaolingUuidNumber">
                       <el-input v-model="ruleForm.shiwuzhaolingUuidNumber"
                                 placeholder="物品编号" clearable  :readonly="ro.shiwuzhaolingUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="物品编号" prop="shiwuzhaolingUuidNumber">
                           <el-input v-model="ruleForm.shiwuzhaolingUuidNumber"
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.shiwuzhaolingPhoto" label="物品照片" prop="shiwuzhaolingPhoto">
                        <file-upload
                            tip="点击上传物品照片"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.shiwuzhaolingPhoto" label="物品照片" prop="shiwuzhaolingPhoto">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="丢失地点/找到地点" prop="shiwuzhaolingAddress">
                       <el-input v-model="ruleForm.shiwuzhaolingAddress"
                                 placeholder="丢失地点/找到地点" clearable  :readonly="ro.shiwuzhaolingAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="丢失地点/找到地点" prop="shiwuzhaolingAddress">
                           <el-input v-model="ruleForm.shiwuzhaolingAddress"
                                     placeholder="丢失地点/找到地点" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="具体时间" prop="jutishijianTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.jutishijianTime"
                                type="datetime"
                                placeholder="具体时间"
                                :disabled="ro.jutishijianTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jutishijianTime" label="具体时间" prop="jutishijianTime">
                            <span v-html="ruleForm.jutishijianTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="详细描述" prop="shiwuzhaolingContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.shiwuzhaolingContent" label="详细描述" prop="shiwuzhaolingContent">
                            <span v-html="ruleForm.shiwuzhaolingContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="状态" prop="shiwuzhaolingZhuangtaiTypes">
                        <el-select v-model="ruleForm.shiwuzhaolingZhuangtaiTypes" :disabled="ro.shiwuzhaolingZhuangtaiTypes" placeholder="请选择状态">
                            <el-option
                                v-for="(item,index) in shiwuzhaolingZhuangtaiTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="状态" prop="shiwuzhaolingZhuangtaiValue">
                        <el-input v-model="ruleForm.shiwuzhaolingZhuangtaiValue"
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    shiwuzhaolingAddress: false,
                    shiwuzhaolingTypes: false,
                    jutishijianTime: false,
                    shiwuzhaolingClicknum: false,
                    shiwuzhaolingContent: false,
                    shiwuzhaolingZhuangtaiTypes: false,
                    insertTime: false,
                },
                ruleForm: {
                    yonghuId: '',
                    ...
                    shiwuzhaolingPhoto: '',
                    shiwuzhaolingAddress: '',
                    shiwuzhaolingTypes: '',
                    jutishijianTime: '',
                    shiwuzhaolingClicknum: '',
                    shiwuzhaolingContent: '',
                    shiwuzhaolingZhuangtaiTypes: '',
                    insertTime: '',
                },
                shiwuzhaolingTypesOptions : [],
                shiwuzhaolingZhuangtaiTypesOptions : [],
                yonghuOptions : [],
                rules: {
                   yonghuId: [
                   ...
                   shiwuzhaolingAddress: [
                              { required: true, message: '丢失地点/找到地点不能为空', trigger: 'blur' },
                          ],
                   shiwuzhaolingTypes: [
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=shiwuzhaoling_zhuangtai_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.shiwuzhaolingZhuangtaiTypesOptions = data.data.list;
                    }
                });
